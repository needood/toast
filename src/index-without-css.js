import styles from "../build/localScopeJson/toast";
...
Android_Toast.prototype.show = function() {
    ...
    var previous_toast = document.getElementById(styles.android_toast_container);
    if (previous_toast) {
        body.removeChild(previous_toast);
    }

    var classes = styles.android_toast_fadein;
    if (this.position === 'top') {
        classes = styles.android_toast_fadein+" "+ styles.android_toast_top;
    }

    var toast_container = document.createElement('div');
    toast_container.setAttribute('id', styles.android_toast_container);
    toast_container.setAttribute('class', classes);
    body.appendChild(toast_container);

    var toast = document.createElement('div');
    toast.setAttribute('id', styles.android_toast);
...
Android_Toast.prototype.hide = function() {
    var toast_container = document.getElementById(styles.android_toast_container);
    ...
    toast_container.className += ' '+styles.android_toast_fadeout;
